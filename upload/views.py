from .serializers import UploadSerializer, NameSerializer
from rest_framework.views import APIView
from rest_framework.parsers import MultiPartParser, FormParser
from rest_framework.response import Response
from .models import Picture
# from uploadpictures.upload_pictures.other.result import waste_classification
...
class UploadPictureAPIView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer_class.is_valid():
            ...
            new_picture = Picture.objects.all().order_by('-add_time')[0]
            return Response({'url': '198.13.45.161:8000/media/' + str(new_picture.image), 'code': 0})
        else:
...
class GetResult(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        data = request.POST.get('name', 'root')
        ...
        path = os.getcwd()
        text_path = path + '/upload/wastetext.txt'
        label_path = path + '/upload/wastelabel.txt'
        pth_path = path + '/upload/text_rnn.pth'
        ...
        name, result = waste_classification(data, 100)
        if name is not None:
            return Response({'result': result, 'name': name, 'code': 0})
        else:
